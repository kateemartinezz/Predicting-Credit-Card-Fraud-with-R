...
dt_orig_pred <- predict(dt.orig,test, type="prob")
...
nb_orig_pred <- predict(nb.orig,test, type="prob")
...
lda_orig_pred <- predict(lda.orig,test, type="prob")
...
################################################
#A. Decision Tree Model predictions
dt_smote_pred <- predict(dt.smote,test, type="prob")
...
##############################################
#A. NB Model predictions
nb_smote_pred <- predict(nb.smote,test, type="prob")
...
######################################
#A. LDA Model predictions
lda_smote_pred <- predict(lda.smote,test, type="prob")
...
#################################################
#A. Decision Tree Model predictions
dt_adas_pred <- predict(dt.adas,test, type="prob")
...
###############################################
#A. NB Model predictions
nb_adas_pred <- predict(nb.adas,test, type="prob")
...
#######################################
#A. LDA Model predictions
lda_adas_pred <- predict(lda.adas,test, type="prob")
...
###################################################
#A. Decision Tree Model predictions
dt_dbsmote_pred <- predict(dt.dbsmote,test, type="prob")
...
#################################################
nb_dbsmote_pred <- predict(nb.dbsmote,test, type="prob")
...
#########################################
#A. LDA Model predictions
lda_dbsmote_pred <- predict(lda.dbsmote,test, type="prob")
